...
class TestEntityAttribute(unittest.TestCase):
    ...
    def test_reverse_entity_attribute_int(self):
        dict_var = dict(type='number',
                        value=1,
                        metadata=dict(python=dict(type='dataType',
                                                  value='int'
                                                  )
                                      )
                        )
    ...
    def test_reverse_entity_attribute_long(self):
        if sys.version_info <= (3, 0):
            ...
            rea = ReverseEntityAttribute(dict_var)
            # self.assertEqual(123456789123456789123, rea.get_value())
            # '-> Python2 is not able to convert it back properly
    ...
    def test_reverse_entity_attribute_dict(self):
        dict_var = dict(type='object',
                        value=dict(a=dict(type='number',
                                          value=1,
                                          metadata=dict(python=dict(type='dataType',
                                                                    value='int'
                                                                    )
    ...
    def test_reverse_entity_attribute_foreign_class(self):
        dict_var = dict(type='ClassInt',
                        value=dict(int=dict(type='number',
                                            value=1,
                                            metadata=dict(python=dict(type='dataType',
                                                                      value='int'
                                                                      )
